  ...
  return (
    <section
      className={cn(
        ...
        size === "tall" ? "min-h-[70vh]" : "min-h-[55vh] md:min-h-[60vh]",
      )}
    >
      <motion.img
        src={image}
      ...
      <div className="container-x relative z-10 pt-32 pb-16 md:pb-20">
        ...
        <h1 className="max-w-4xl font-display text-[clamp(2.4rem,5.5vw,4.5rem)] leading-[1.05] tracking-tight text-cream">
